...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proPrice = findViewById((R.id.prodPric));
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    Toast.makeText(Payment.this,"Fill all above details and try again.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(Payment.this,"Google pay is not installed. Please istall and try again.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(Payment.this, "Transaction successful. "+approvalRefNo, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Payment.this, "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
