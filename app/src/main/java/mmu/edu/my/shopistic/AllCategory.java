...
import mmu.edu.my.shopistic.adapter.AllCategoryAdapter;
import mmu.edu.my.shopistic.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.ic_home_shoes));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.ic_home_heels));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.ic_home_watch));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.ic_home_health));
